//
//  AddressDeleteViewController.swift
...
class AddressDeleteViewController: UIViewController , OPayPaymentAddressOperationsProcessDelegate {
    ...
    @IBAction func SubmitButtonClicked(sender : UIButton)
    {
        ...
        self.getDataFromPlist();
         ...
         self.opayAddressOperationsController.deleteAddress(self, profileID: profileId, addressID:Utils.getAddressID() as? String)
