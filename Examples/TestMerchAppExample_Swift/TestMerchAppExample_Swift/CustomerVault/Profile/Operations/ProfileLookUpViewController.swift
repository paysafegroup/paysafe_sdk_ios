//
//  ProfileLookUpViewController.swift
...
class ProfileLookUpViewController: UIViewController , OPayPaymentProfileOperationsProcessDelegate {
    ...
    @IBAction func SubmitButtonClicked(sender : UIButton)
    {
        ...
        self.opayProfileOperationsController.lookupProfile(self, profileID: Utils.getProfileID() as? String) 
        }
    }
    ...
    func getDataFromPlist()
    {
        ...
        self.opayProfileOperationsController.authDelegate = self;
    }
